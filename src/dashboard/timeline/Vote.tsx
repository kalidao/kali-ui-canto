...
export default function Vote({
    ...
    return <Stack direction={"horizontal"}>
        <Button size="small" shape="circle" tone="blue" variant="secondary" loading={yesLoading} disabled={!yesWrite || yesSuccess} onClick={() => yesWrite?.()}>
            <IconCheck />
        </Button>
        <Button size="small" shape="circle" tone="red" variant="secondary" loading={noLoading} disabled={!noWrite || noSuccess} onClick={() => noWrite?.()}>
            <IconClose />
        </Button>
    </Stack>
}